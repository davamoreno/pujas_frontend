    ...
    <div class="container py-4">
      ...
      <div class="mb-4">
        <div class="input-group">
          ...
          <input type="text" class="form-control border-start-0" placeholder="Search..." v-model="searchQuery" />
        </div>
      </div>
      ...
      <section class="mb-4">
        ...
        <div class="row g-3">
          <div class="col-6 col-md-4 col-lg-3" v-for="item in favoriteItems" :key="item.id">
            <div class="card item-card text-center p-2 shadow-sm border-0 h-100">
              ...
              <div class="card-body p-2">
                ...
                <button class="btn btn-outline-success w-100" @click="addToCart(item)">
                  Tambahkan
                </button>
              </div>
            </div>
      ...
      <section class="mb-5">
        ...
        <div class="row g-3">
          <div class="col-6 col-md-4 col-lg-3" v-for="item in drinkItems" :key="item.id">
            <div class="card item-card text-center p-2 shadow-sm border-0 h-100">
              <img :src="item.image" class="card-img-top rounded-3" alt="Menu" />
              <div class="card-body p-2">
                <h6 class="fw-semibold mb-1">{{ item.name }}</h6>
